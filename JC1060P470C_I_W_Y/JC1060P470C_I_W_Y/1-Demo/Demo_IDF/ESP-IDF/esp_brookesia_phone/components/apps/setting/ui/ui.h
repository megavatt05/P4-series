...
//ethernet
extern lv_obj_t *ui_ethernetMainItem;
extern lv_obj_t *ui_ethernetMainIcon;
extern lv_obj_t *ui_ethernetMainLable;
extern lv_obj_t *ui_ethernetMainButton;
...
LV_IMG_DECLARE(app_ethernet_icon);
