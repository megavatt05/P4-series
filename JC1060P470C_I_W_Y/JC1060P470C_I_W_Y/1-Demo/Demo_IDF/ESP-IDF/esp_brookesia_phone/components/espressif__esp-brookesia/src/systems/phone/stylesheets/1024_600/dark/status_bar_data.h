...
#define ESP_BROOKESIA_PHONE_1024_600_DARK_STATUS_BAR_DATA()                                                      \
    {                                                                                                     \
        ...
        .ethernet = {                                                                                     \
            ...
            .icon_data = {                                                                                \
                .icon = {                                                                                 \
                    .image_num = 2,                                                                       \
                    .images = {                                                                           \
                        ESP_BROOKESIA_STYLE_IMAGE_RECOLOR_WHITE(&esp_brookesia_image_large_status_bar_ethernet_level0_36_36),      \
                        ESP_BROOKESIA_STYLE_IMAGE_RECOLOR_WHITE(&esp_brookesia_image_large_status_bar_ethernet_level1_36_36),    \
                    },                                                                                    \
                },                                                                                        \
            },                                                                                            \
        },\
        ...
        .flags = {                                                                                        \
            ...
            .enbale_ethernet_icon = 1,                                                                      \
            .enable_ethernet_icon_common_size = 1,                                                            \
            .enable_clock = 1,                                                                            \
        },                                                                                                \
    }
